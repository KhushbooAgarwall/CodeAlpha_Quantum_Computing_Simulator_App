...
import com.khushboo.quantumcomputingsimulator.UIHelper;
import com.khushboo.quantumcomputingsimulator.math.Complex;
import com.khushboo.quantumcomputingsimulator.tools.Doable;
import com.khushboo.quantumcomputingsimulator.tools.DoableType;
import com.khushboo.quantumcomputingsimulator.tools.GateSequence;
import com.khushboo.quantumcomputingsimulator.math.VisualOperator;
import com.khushboo.quantumcomputingsimulator.tools.QuantumViewData;
...
public class QuantumView extends View {
    ...
    public QuantumViewData getData() {
        return new QuantumViewData(undoList, redoList, new GateSequence<>(visualOperators, name), statevector != null ? new LinkedList(Arrays.asList(statevector)) : new LinkedList<>());
    }
